...
<section class="feature-section" id="features">
  ...
  <div class="feature-grid">
    <article class="feature-card feature-card--signal feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/bgm-playlist.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/bgm-playlist.png' | relative_url }}" alt="背景音乐播放器显示循环播放清单与播放控制" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">播放协调</span><h3>BGM 与伴奏自动交接</h3><p>请先选择 BGM 并开始播放。伴奏开始时会自动暂停或淡出 BGM；伴奏停止或播放完毕后，会自动恢复原来的背景音乐。</p></div></article>
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/song-library.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/song-library.png' | relative_url }}" alt="歌曲库显示歌单、搜索框与多首歌曲" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">歌曲与待播</span><h3>整理歌曲，也保留临场弹性</h3><p>整理歌曲与待播，可直接播放伴奏，也能为清唱或自弹自唱建立无伴奏演出。</p></div></article>
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/theme-workspace.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/theme-workspace.png' | relative_url }}" alt="歌单外观页面显示多种 OBS 歌单主题与实时预览" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">OBS 歌单</span><h3>切换主题，不必手动重打歌单</h3><p>选择 Default、透明、Card、CD 或精致主题，先通过自动展示检查完整状态，再拖入 OBS。</p></div></article>
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/lyrics-manager-linked.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/lyrics-manager-linked.png' | relative_url }}" alt="歌词管理窗口显示同步歌词搜索结果与已关联歌词" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">歌词</span><h3>自己阅读，也能显示给观众</h3><p>搜索或导入同步歌词，使用可移动的“歌词窗口”阅读，也能建立 OBS 歌词画面。日文支持平假名与罗马拼音，韩文也可显示罗马拼音。</p></div></article>
    ...
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/compact-workspace.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/compact-workspace.png' | relative_url }}" alt="精简工作区显示歌词、BGM、伴奏与待播控制" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">工作区</span><h3>完整、精简、迷你三种模式</h3><p>准备直播时使用完整模式；开播后可缩为精简或迷你模式。也可隐藏到 Windows 通知区域，通过托盘菜单或全局快捷键继续控制直播。</p></div></article>
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/advanced-streaming/26-song-profile-tag-menu.png' | relative_url }}"><img src="{{ '/assets/images/advanced-streaming/26-song-profile-tag-menu.png' | relative_url }}" alt="歌曲列表打开人声 Profile 标签菜单，为歌曲指定演唱效果" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">歌曲人声</span><h3>播放伴奏时，自动切换歌曲的人声效果</h3><p>每首歌都可指定不同的麦克风 Profile；伴奏开始时自动套用，结束后回到聊天设置，也能在直播中手动切换。</p></div></article>
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/profile-horizontal-rack.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/profile-horizontal-rack.png' | relative_url }}" alt="人声 Profile 编辑器用横向 Rack 显示多种效果" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">人声 Profiles</span><h3>使用内置效果与 VST3 组成效果链</h3><p>使用噪声门、压缩器、EQ、Reverb、Delay、Shimmer 等 15 个内置效果，或加入 VST3；可调参数、旁路并拖动处理顺序。</p></div></article>
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/audio-routing-bottom.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/audio-routing-bottom.png' | relative_url }}" alt="音频路由图连接麦克风、Profile、直播混音、输出与监听" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">直播音频</span><h3>把伴奏与人声混合后直接送到 OBS</h3><p>支持 ASIO、Windows Audio、OBS 专用音频插件与虚拟音频设备；Final Mix、OBS 与完整输出录音共用稳定、对齐的正式路径。</p></div></article>
    ...
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/audio-meter-horizontal.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/audio-meter-horizontal.png' | relative_url }}" alt="横向 Meter 显示 BGM、伴奏、人声与直播输出的实时音量" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">Meter 与健康检查</span><h3>查看音量、Buffer、延迟与中断</h3><p>五轨 Meter 显示 Peak 与 Stream Output 的 LUFS-S；Buffer 健康检查可比较稳定度、预计延迟并提供可直接套用的建议。</p></div></article>
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/live-timeline-card.jpg' | relative_url }}"><img src="{{ '/assets/images/live-timeline-card.jpg' | relative_url }}" alt="直播画面中的 Now Singing、Next On 与歌曲时间戳" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">直播时间戳</span><h3>让 Set List 显示实际直播时间轴</h3><p>通过 OBS WebSocket 记录每首伴奏开始的直播时间，并在支持的 Set List 显示时间戳；一般歌单与歌词无需启用。</p></div></article>
  </div>
</section>
