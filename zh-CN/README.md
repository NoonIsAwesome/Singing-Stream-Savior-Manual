...
<section class="feature-section" id="features">
  ...
  <div class="feature-grid">
    ...
    <article class="feature-card feature-card--illustrated"><a class="feature-card__visual" href="{{ '/assets/images/zh-CN/audio-health-check.png' | relative_url }}"><img src="{{ '/assets/images/zh-CN/audio-health-check.png' | relative_url }}" alt="音频 Buffer 健康检查结果显示稳定度、延迟与建议设置" loading="lazy" decoding="async"></a><div class="feature-card__body"><span class="feature-card__label">Meter 与健康检查</span><h3>查看音量、Buffer、延迟与中断</h3><p>五轨 Meter 显示 Peak 与 Stream Output 的 LUFS-S；Buffer 健康检查可比较稳定度、预计延迟并提供可直接套用的建议。</p></div></article>
