---
title: 歌回救星 2.1 使用说明
description: Singing Stream Savior 2.1.2.1 简体中文使用说明
lang: zh-CN
...
歌回救星（Singing Stream Savior）是为歌回直播设计的 Windows 工具，将歌曲库、BGM、歌唱伴奏、待播、歌词、音频路由、人声效果与 OBS 画面整合在同一套流程中。本说明适用于 **2.1.2.1**。
...
> **音源与播放用途：** 加入歌曲库只代表建立播放项目，不代表取得音乐授权。请确认素材来源及其使用条件；个人聆听、音频分离、直播、录像留存与分享输出文件，可能需要不同的权利范围。YouTube 来源另受适用的平台规范限制。
...
封面不是必需，仅在 Card 与 CD 主题下有特别效果。

> **封面使用提醒：** 封面搜索仅协助查找图片。在公开直播或视频中使用前，请确认相应权限；也可以使用自行制作或已取得适当授权的图片。
...
> **开始前，请确认素材的使用范围。**
>
> 请使用您拥有相关权利、授权涵盖音频分离，或依法可利用的素材。购买音频、能够在网上播放，或由其他人分享，均不当然表示可以分离、直播、上传或散布。
>
> 本功能不提供歌曲授权。分离结果仍可能包含受保护的词曲与录音；公开使用前，请确认现有授权是否涵盖预定用途。使用 YouTube 来源时，也须遵守适用的平台规范。
