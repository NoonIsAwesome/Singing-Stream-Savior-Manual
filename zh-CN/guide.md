---
title: 歌回救星 2.1 使用说明
description: Singing Stream Savior 2.1.4.0 简体中文使用说明
lang: zh-CN
...
歌回救星（Singing Stream Savior）是为歌回直播设计的 Windows 工具，将歌曲库、BGM、歌唱伴奏、待播、歌词、音频路由、人声效果与 OBS 画面整合在同一套流程中。本说明适用于 **2.1.4.0**。
