...
description: Singing Stream Savior 2.1.5.4 한국어 설명서
lang: ko
...
Singing Stream Savior는 노래 방송을 위한 Windows 앱입니다. 곡 라이브러리, BGM, 반주, 대기 목록, 가사, 보컬 처리, 오디오 라우팅과 OBS 출력을 하나의 흐름으로 관리합니다. 이 설명서는 **2.1.5.4** 버전을 기준으로 합니다.
