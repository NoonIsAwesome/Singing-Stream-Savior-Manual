...
5. **選擇歌單主題並拖入 OBS**：切換到「歌單外觀」，透過自動預覽確認主題效果，再按住「拖曳至 OBS」並拖到 OBS 視窗。第一次可先嘗試 Transparent Black V2。
...
8. **把同步歌詞顯示到 OBS**：切換到「歌詞」分頁，也可在這裡手動開啟「管理歌詞」。接著按住「拖曳至 OBS」並拖進 OBS 視窗，歌詞就會跟隨伴奏時間顯示。
